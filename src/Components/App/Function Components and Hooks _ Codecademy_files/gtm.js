...
function(){}};function le(a,b){var c=Sd(a,b);c.vtp_permissionName=a;c.vtp_createPermissionError=me;try{return Td(c)}catch(d){return{assert:function(e){throw new Yd(e,{},"Permission "+e+" is unknown.");},P:function(){for(var e={},f=0;f<arguments.length;++f)e["arg"+(f+1)]=arguments[f];return e}}}}function me(a,b,c){return new Yd(a,b,c)};var qe=!1;var re={};re.Gi=ab('');re.vh=ab('');var se=qe,te=re.vh,ue=re.Gi;var Je=/^[a-z$_][\w$]*$/i,Ke=/^(?:[a-z_$][a-z_$0-9]*\.)*[a-z_$][a-z_$0-9]*(?:\.\*)?$/i;
...
"set",t);f(g+"require",b.vtp_optimizeContainerId,{dataLayer:"dataLayer"});f(b.vtp_gtmOnSuccess);f(g+"require","render");a||(a=!0,R(r,function(){return Nk().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure));var u=S("dataLayer"),v=u&&u.hide;v&&(v.end||!0===v["GTM-KTLK85W"])&&(v[b.vtp_optimizeContainerId]=!0)}else N(b.vtp_gtmOnFailure)})}();
...
Z.h.read_data_layer=["google"],function(){function a(b,c){return{key:c}}(function(b){Z.__read_data_layer=b;Z.__read_data_layer.i="read_data_layer";Z.__read_data_layer.m=!0;Z.__read_data_layer.priorityOverride=0})(function(b){var c=b.vtp_keyPatterns||[],d=b.vtp_createPermissionError;return{assert:function(e,f){if(!q(f))throw d(e,{},"Keys must be strings.");try{var g;a:{for(var h=0;h<c.length;h++){var l=f,m=c[h];if(!Ke.exec(m))throw Error("Invalid key wildcard");var p=m.indexOf(".*"),n=-1!==p&&p===
m.length-2,t=n?m.slice(0,m.length-2):m,r;b:if(0===l.length)r=!1;else{for(var u=l.split("."),v=0;v<u.length;v++)if(!Je.exec(u[v])){r=!1;break b}r=!0}if(!r||t.length>l.length||!n&&l.length!=m.length?0:n?0===l.indexOf(t)&&(l===t||"."==l.charAt(t.length)):l===t){g=!0;break a}}g=!1}if(g)return}catch(w){throw d(e,{},"Invalid key filter.");}throw d(e,{},"Prohibited read from data layer variable: "+f+".");},P:a}})}();
...
Z.h.inject_hidden_iframe=["google"],function(){function a(b,c){return{url:c}}(function(b){Z.__inject_hidden_iframe=b;Z.__inject_hidden_iframe.i="inject_hidden_iframe";Z.__inject_hidden_iframe.m=!0;Z.__inject_hidden_iframe.priorityOverride=0})(function(b){var c=b.vtp_urls||[],d=b.vtp_createPermissionError;return{assert:function(e,f){if(!q(f))throw d(e,{},"Iframe URL must be a string.");try{if(Qe(ch(f),c))return}catch(g){throw d(e,{},"Invalid iframe URL filter.");}throw d(e,{},"Prohibited iframe URL: "+
f);},P:a}})}();
